            ...
            <div class="container">
                ...
                <div class="row row2">
                    <div class="col-sm-2">
                        ...
                        <h1 class="animated infinite rubberBand" ><span style="font-size: 20px; font-weight: bold; margin-right: 10%;" class="largenav">Concesionario</span></h1> 
                    </div>
                    <div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                        <div class="row">
                            ...
                            <div class="row">
                                <button class="btn btn-danger"  onClick="location.href='../../presentation/client/newClient.jsp'">Crear Cliente</button>
                            </div>
                        </div>
