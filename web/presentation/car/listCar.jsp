...
<center><div class="label"><legend>Lista de Vehiculos</legend>
        <br>
        <div style="padding-bottom: 3vh"><input  style="width: 25%"type="text" placeholder="ingrese placa"><button>Buscar</button></div>            
</div></center> 
