            ...
            <h1><span style="font-size: 20px; font-weight: bold; margin-right: 10%; margin-top: 7%;" class="largenav">Concesionario</span></h1></div>
                    ...
                    <div class="flipkart-navbar-search smallsearch col-sm-8 col-xs-11">
                        <div class="row animated bounceInDown">
                            <input  class="flipkart-navbar-input col-xs-11 " style="float: left; color: black; font-weight: bold;" id="searchTerm" type="text" onkeyup="doSearch()" placeholder="Buscar Clientes" required pattern="[a-z]+">
